...
### 3.5 Calculations and Filters

#### 3.5.1 Cumulative count % across GPA order
...
#### 3.5.2 Count % of GPA across Gender Demographic
...
#### 3.5.3 Filtered view for parents' educational level
...
#### 3.5.5 Filter for Support of Lecturer
