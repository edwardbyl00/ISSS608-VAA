...
con <- dbConnect(
  ...
  .connection_string = paste0(
    ...
    "DBQ=", normalizePath("Data/Coffee Chain.mdb", winslash = "\\")
  )
)

coffeechain <- dbReadTable(con, "CoffeeChain Query")
saveRDS(coffeechain, "Data/CoffeeChain.rds")
dbDisconnect(con)
```
...
One of the requirement of gtExtras functions is that almost exclusively they require us to pass data.frame with list columns.
...
Next add the statistics on the table.
...
Create interactive information dashboard by using [reactable](https://glin.github.io/reactable/index.html) and [reactablefmtr](https://kcuilla.github.io/reactablefmtr/index.html) packages.
...
Plot the sparklines using [react_sparkline](https://kcuilla.github.io/reactablefmtr/reference/react_sparkline.html)
